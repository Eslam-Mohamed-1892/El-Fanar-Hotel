...
export default function Footer() {
    ...
    return (
        <footer
            id='footer'
            name="footer"
            className='w-full bg-slate-900 text-white inter-font px-6 py-10'
        >
            <div className='w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-8'>
                ...
                <div className='flex flex-col gap-3 mb-4'>
                    ...
                    <nav className='flex flex-col gap-2 font-semibold cursor-pointer'>
                        <Link spy={true} offset={-90} to='hero' smooth={true} duration={1200} className='hover:text-cyan-400 transition-colors hover:translate-x-1'>Home</Link>
                        <Link spy={true} offset={-90} to='about' smooth={true} duration={1200} className='hover:text-cyan-400 transition-colors hover:translate-x-1'>About</Link>
                        <Link spy={true} offset={-90} to='explore' smooth={true} duration={1200} className='hover:text-cyan-400 transition-colors hover:translate-x-1'>Explore El Fanar</Link>
                        <Link spy={true} offset={-90} to='faq' smooth={true} duration={1200} className='hover:text-cyan-400 transition-colors hover:translate-x-1'>FAQ</Link>
                        <Link spy={true} offset={-90} to='contact' smooth={true} duration={1200} className='hover:text-cyan-400 transition-colors hover:translate-x-1'>Contact</Link>
                    </nav>
                </div>
                <div className='flex flex-col gap-3 mb-4'>
