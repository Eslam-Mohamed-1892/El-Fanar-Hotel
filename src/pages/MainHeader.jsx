    ...
    return (
        <header className="w-full h-[12vh] bg-gray-800 px-10 fixed top-0 left-0 z-20">
            <div className="h-full w-full flex justify-between items-center">
                ...
                <nav className="inter-title hidden md:flex md:gap-7 text-white font-semibold">
                    <a href="Hero">Home</a>
                    <a href="About">About</a>
                    <a href="#">Explore El Fanar</a>
                    <a href="#">Contact</a>
                    <a href="#">Footer</a>
                </nav>
                <HiMenu
            ...
            {open && (
                <div className="inter-title flex md:hidden flex-col items-center gap-4 py-6 text-white bg-[#0e0e0ea2]">
                    <a href="Hero">Home</a>
                    <a href="About">About</a>
                    <a href="#">Explore El Fanar</a>
                    <a href="#">Contact</a>
